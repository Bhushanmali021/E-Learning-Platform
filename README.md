...
| **User Features** | **Admin Features** | **Technical Stack** |
|-------------------|-------------------|-------------------|
| 🔐 Secure Auth (Signup/Login/Logout) | 📚 Course CRUD Operations | ⚙️ Django ORM + SQLite |
| 📖 Browse/Filter/Search Courses | 👥 Complete User Management | 💳 Payment Gateway Integration |
| 🛒 Instant Course Enrollment | 💰 Dynamic Discount Management | 📱 Bootstrap 5 Responsive |
| 💵 Discounted Payments | 📊 Analytics Dashboard | 🔍 Advanced Search & Filtering |


__Project Structure__
E-Learning-Platform/
├── core/                       # 🔥 Main Django App
│   ├── models.py              # UserProfile, Course, Enrollment
│   ├── views.py               # Business Logic (CBV+FBV)
│   ├── forms.py               # Custom Forms & Validation
│   ├── admin.py               # Production Admin Panel
