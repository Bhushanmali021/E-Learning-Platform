...
class PaymentAdmin(admin.ModelAdmin):
    ...
    def get_course(self , payment):
        return format_html(f"<a target = '_blank' href = '/admin/courses/course/{payment.user.id}'>{payment.course}</a>")
...
class UserCourseAdminModel(admin.ModelAdmin):
    ...
    def get_course(self , usercourse):
        return format_html(f"<a target = '_blank' href = '/admin/courses/course/{usercourse.user.id}'>{usercourse.course}</a>")
